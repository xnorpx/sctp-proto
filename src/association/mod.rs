...
impl Association {
    ...
    /// Creates a new association using out-of-band INIT chunks.
    ///
    /// This allows skipping the SCTP 4-way handshake by exchanging INIT chunks
    /// out-of-band (e.g., via a signaling channel). The association immediately
    ...
    pub(crate) fn new_with_out_of_band_init(
        ...
        this.peer_last_tsn = if remote_init.initial_tsn == 0 {
            u32::MAX
        } else {
            remote_init.initial_tsn - 1
        };
